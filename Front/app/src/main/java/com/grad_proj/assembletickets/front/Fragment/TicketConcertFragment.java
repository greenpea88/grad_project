...
public class TicketConcertFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        concertShowAdapter.setOnItemClickListener(new ShowAdapter.OnItemClickListener() {
            @Override
            public void onItemClicked(View v, int position) {
                ...
                ((HomeActivity)getActivity()).replaceFragment(ShowDetailFragment.newInstance(concertShowAdapter.getItem(position)));
            }
        });
        ...
        new GetConcertShows().execute("http://ticketdate.azurewebsites.net/assemble-ticket/shows/type");
