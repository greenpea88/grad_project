...
public class TicketMusicalFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        musicalShowAdapter.setOnItemClickListener(new ShowAdapter.OnItemClickListener() {
            @Override
            public void onItemClicked(View v, int position) {
                ...
                ((HomeActivity)getActivity()).replaceFragment(ShowDetailFragment.newInstance(musicalShowAdapter.getItem(position)));
            }
        });
